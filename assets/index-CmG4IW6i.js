(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function r(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=r(n);fetch(n.href,s)}})();class at{enabled=!0;owner;radius;layer;isTrigger;scene;onTriggerEnter;constructor(t,r,i,n=!0){this.radius=r,this.layer=i,this.isTrigger=n,this.scene=t}start(){}update(t){}onAttach(){this.scene.collisionSystem.add(this)}onDetach(){this.scene.collisionSystem.remove(this)}}class xe{colliders=[];add(t){this.colliders.push(t)}remove(t){this.colliders=this.colliders.filter(r=>r!==t)}update(t){const r=this.colliders.length;for(let i=0;i<r;i++){const n=this.colliders[i],s=n.owner;if(!n.enabled||!s)continue;const o=s.transform.getWorldPosition();for(let a=i+1;a<r;a++){const c=this.colliders[a],h=c.owner;if(!c.enabled||!h||!this.shouldCollide(n,c))continue;const l=h.transform.getWorldPosition(),u=o[0]-l[0],f=o[1]-l[1],m=o[2]-l[2],v=n.radius+c.radius;u*u+f*f+m*m<=v*v&&n.isTrigger&&c.isTrigger&&(n.onTriggerEnter?.(c),c.onTriggerEnter?.(n))}}}shouldCollide(t,r){return!0}}class we{objects=[];_mainCamera=null;destroyQueue=[];collisionSystem=new xe;addObject(t){this.objects.push(t),t.scene=this}removeObject(t){const r=this.objects.indexOf(t);r>=0&&this.objects.splice(r,1)}markForDestroy(t){this.destroyQueue.push(t)}findByName(t){return this.objects.find(r=>r.name===t)??null}setMainCamera(t){this._mainCamera=t}get MainCamera(){return this._mainCamera}update(t){for(const r of this.objects)r.update(t);if(this.collisionSystem.update(t),this.destroyQueue.length>0){const r=new Set(this.destroyQueue);for(const i of this.destroyQueue)i.forEachComponent(n=>n.onDetach?.());this.objects=this.objects.filter(i=>!r.has(i)),this.destroyQueue.length=0}}getObjects(){return this.objects}}class W{enabled=!0;mesh;constructor(t){this.mesh=t}start(){}update(t){}onAttach(){}onDetach(){}setMesh(t){this.mesh=t}}class j{enabled=!0;owner;gl;material;vao=null;vbo=null;ibo=null;vertexCount=0;indexCount=0;constructor(t,r){this.gl=t,this.material=r}start(){if(!this.owner){console.warn("MeshRenderer: owner が設定されていません");return}const t=this.owner.getComponent(W);if(!t||!t.mesh){console.warn("MeshRenderer: MeshFilter または mesh が設定されていません.");return}this.initBuffers(t.mesh)}update(t){}onAttach(){}onDetach(){const t=this.gl;this.vao&&(t.deleteVertexArray(this.vao),this.vao=null),this.vbo&&(t.deleteBuffer(this.vbo),this.vbo=null),this.ibo&&(t.deleteBuffer(this.ibo),this.ibo=null)}initBuffers(t){const r=this.gl,i=t.vertices;if(!i||i.length===0){console.warn("MeshRenderer: vertices が空です");return}const n=i[0].uv!==void 0,s=3,o=n?2:0,a=4,c=s+o,h=c*a,l=i.flatMap(v=>n?[...v.pos,...v.uv]:[...v.pos]),u=new Float32Array(l);this.vertexCount=u.length/c,this.vao=r.createVertexArray(),this.vbo=r.createBuffer(),this.ibo=null,r.bindVertexArray(this.vao),r.bindBuffer(r.ARRAY_BUFFER,this.vbo),r.bufferData(r.ARRAY_BUFFER,u,r.STATIC_DRAW);let f=0;const m=r.getAttribLocation(this.material.program.program,"aPosition");if(m>=0&&(r.enableVertexAttribArray(m),r.vertexAttribPointer(m,s,r.FLOAT,!1,h,f)),f+=s*a,n){const v=r.getAttribLocation(this.material.program.program,"aTexCoord");v>=0&&(r.enableVertexAttribArray(v),r.vertexAttribPointer(v,o,r.FLOAT,!1,h,f)),f+=o*a}t.indices&&t.indices.length>0&&(this.ibo=r.createBuffer(),r.bindBuffer(r.ELEMENT_ARRAY_BUFFER,this.ibo),r.bufferData(r.ELEMENT_ARRAY_BUFFER,new Uint16Array(t.indices),r.STATIC_DRAW),this.indexCount=t.indices.length),r.bindVertexArray(null)}render(t){const r=this.gl;!this.vao||!this.owner||(this.material.bind(r,this.owner,t),r.bindVertexArray(this.vao),this.ibo&&this.indexCount>0?r.drawElements(r.TRIANGLES,this.indexCount,r.UNSIGNED_SHORT,0):this.vertexCount>0&&r.drawArrays(r.TRIANGLES,0,this.vertexCount),r.bindVertexArray(null))}}class be{gl;constructor(t){this.gl=t}render(t,r,i=null){const n=this.gl;n.bindFramebuffer(n.FRAMEBUFFER,i?i.fbo:null);const s=i?i.width:n.drawingBufferWidth,o=i?i.height:n.drawingBufferHeight;n.viewport(0,0,s,o),n.enable(n.DEPTH_TEST),n.depthMask(!0),n.clearColor(0,0,0,1),n.clear(n.COLOR_BUFFER_BIT|n.DEPTH_BUFFER_BIT);const a=t.getObjects();for(const c of a){if(!c.active)continue;const h=c.getComponent(j);!h||!h.enabled||(c.layer&r.cullingMask)!=0&&h.render(r)}}}var Te=1e-6,D=typeof Float32Array<"u"?Float32Array:Array,Fe="zyx";function Re(){var e=new D(9);return D!=Float32Array&&(e[1]=0,e[2]=0,e[3]=0,e[5]=0,e[6]=0,e[7]=0),e[0]=1,e[4]=1,e[8]=1,e}function $(){var e=new D(16);return D!=Float32Array&&(e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[11]=0,e[12]=0,e[13]=0,e[14]=0),e[0]=1,e[5]=1,e[10]=1,e[15]=1,e}function Me(e,t){return e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[3],e[4]=t[4],e[5]=t[5],e[6]=t[6],e[7]=t[7],e[8]=t[8],e[9]=t[9],e[10]=t[10],e[11]=t[11],e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15],e}function Bt(e,t){var r=t[0],i=t[1],n=t[2],s=t[3],o=t[4],a=t[5],c=t[6],h=t[7],l=t[8],u=t[9],f=t[10],m=t[11],v=t[12],p=t[13],b=t[14],R=t[15],P=r*a-i*o,y=r*c-n*o,g=r*h-s*o,x=i*c-n*a,w=i*h-s*a,J=n*h-s*c,tt=l*p-u*v,et=l*b-f*v,rt=l*R-m*v,it=u*b-f*p,nt=u*R-m*p,st=f*R-m*b,E=P*st-y*nt+g*it+x*rt-w*et+J*tt;return E?(E=1/E,e[0]=(a*st-c*nt+h*it)*E,e[1]=(n*nt-i*st-s*it)*E,e[2]=(p*J-b*w+R*x)*E,e[3]=(f*w-u*J-m*x)*E,e[4]=(c*rt-o*st-h*et)*E,e[5]=(r*st-n*rt+s*et)*E,e[6]=(b*g-v*J-R*y)*E,e[7]=(l*J-f*g+m*y)*E,e[8]=(o*nt-a*rt+h*tt)*E,e[9]=(i*rt-r*nt-s*tt)*E,e[10]=(v*w-p*g+R*P)*E,e[11]=(u*g-l*w-m*P)*E,e[12]=(a*et-o*it-c*tt)*E,e[13]=(r*it-i*et+n*tt)*E,e[14]=(p*y-v*x-b*P)*E,e[15]=(l*x-u*y+f*P)*E,e):null}function Ee(e,t,r){var i=t[0],n=t[1],s=t[2],o=t[3],a=t[4],c=t[5],h=t[6],l=t[7],u=t[8],f=t[9],m=t[10],v=t[11],p=t[12],b=t[13],R=t[14],P=t[15],y=r[0],g=r[1],x=r[2],w=r[3];return e[0]=y*i+g*a+x*u+w*p,e[1]=y*n+g*c+x*f+w*b,e[2]=y*s+g*h+x*m+w*R,e[3]=y*o+g*l+x*v+w*P,y=r[4],g=r[5],x=r[6],w=r[7],e[4]=y*i+g*a+x*u+w*p,e[5]=y*n+g*c+x*f+w*b,e[6]=y*s+g*h+x*m+w*R,e[7]=y*o+g*l+x*v+w*P,y=r[8],g=r[9],x=r[10],w=r[11],e[8]=y*i+g*a+x*u+w*p,e[9]=y*n+g*c+x*f+w*b,e[10]=y*s+g*h+x*m+w*R,e[11]=y*o+g*l+x*v+w*P,y=r[12],g=r[13],x=r[14],w=r[15],e[12]=y*i+g*a+x*u+w*p,e[13]=y*n+g*c+x*f+w*b,e[14]=y*s+g*h+x*m+w*R,e[15]=y*o+g*l+x*v+w*P,e}function Ae(e,t,r,i){var n=t[0],s=t[1],o=t[2],a=t[3],c=n+n,h=s+s,l=o+o,u=n*c,f=n*h,m=n*l,v=s*h,p=s*l,b=o*l,R=a*c,P=a*h,y=a*l,g=i[0],x=i[1],w=i[2];return e[0]=(1-(v+b))*g,e[1]=(f+y)*g,e[2]=(m-P)*g,e[3]=0,e[4]=(f-y)*x,e[5]=(1-(u+b))*x,e[6]=(p+R)*x,e[7]=0,e[8]=(m+P)*w,e[9]=(p-R)*w,e[10]=(1-(u+v))*w,e[11]=0,e[12]=r[0],e[13]=r[1],e[14]=r[2],e[15]=1,e}function Se(e,t,r,i,n){var s=1/Math.tan(t/2);if(e[0]=s/r,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=s,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[11]=-1,e[12]=0,e[13]=0,e[15]=0,n!=null&&n!==1/0){var o=1/(i-n);e[10]=(n+i)*o,e[14]=2*n*i*o}else e[10]=-1,e[14]=-2*i;return e}var De=Se,Tt=Ee;function T(){var e=new D(3);return D!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0),e}function Pe(e){var t=new D(3);return t[0]=e[0],t[1]=e[1],t[2]=e[2],t}function Wt(e){var t=e[0],r=e[1],i=e[2];return Math.sqrt(t*t+r*r+i*i)}function A(e,t,r){var i=new D(3);return i[0]=e,i[1]=t,i[2]=r,i}function N(e,t){return e[0]=t[0],e[1]=t[1],e[2]=t[2],e}function G(e,t,r,i){return e[0]=t,e[1]=r,e[2]=i,e}function H(e,t,r){return e[0]=t[0]+r[0],e[1]=t[1]+r[1],e[2]=t[2]+r[2],e}function _e(e,t,r){return e[0]=t[0]-r[0],e[1]=t[1]-r[1],e[2]=t[2]-r[2],e}function V(e,t,r){return e[0]=t[0]*r,e[1]=t[1]*r,e[2]=t[2]*r,e}function jt(e,t,r,i){return e[0]=t[0]+r[0]*i,e[1]=t[1]+r[1]*i,e[2]=t[2]+r[2]*i,e}function Ce(e,t){var r=t[0]-e[0],i=t[1]-e[1],n=t[2]-e[2];return Math.sqrt(r*r+i*i+n*n)}function O(e,t){var r=t[0],i=t[1],n=t[2],s=r*r+i*i+n*n;return s>0&&(s=1/Math.sqrt(s)),e[0]=t[0]*s,e[1]=t[1]*s,e[2]=t[2]*s,e}function Yt(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function gt(e,t,r){var i=t[0],n=t[1],s=t[2],o=r[0],a=r[1],c=r[2];return e[0]=n*c-s*a,e[1]=s*o-i*c,e[2]=i*a-n*o,e}function Ue(e,t,r,i){var n=t[0],s=t[1],o=t[2];return e[0]=n+i*(r[0]-n),e[1]=s+i*(r[1]-s),e[2]=o+i*(r[2]-o),e}var ct=_e,Ve=Wt;(function(){var e=T();return function(t,r,i,n,s,o){var a,c;for(r||(r=3),i||(i=0),n?c=Math.min(n*r+i,t.length):c=t.length,a=i;a<c;a+=r)e[0]=t[a],e[1]=t[a+1],e[2]=t[a+2],s(e,e,o),t[a]=e[0],t[a+1]=e[1],t[a+2]=e[2];return t}})();function Le(){var e=new D(4);return D!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0,e[3]=0),e}function k(e,t,r,i){var n=new D(4);return n[0]=e,n[1]=t,n[2]=r,n[3]=i,n}function Be(e,t){return e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[3],e}function ze(e,t){var r=t[0],i=t[1],n=t[2],s=t[3],o=r*r+i*i+n*n+s*s;return o>0&&(o=1/Math.sqrt(o)),e[0]=r*o,e[1]=i*o,e[2]=n*o,e[3]=s*o,e}function xt(e,t,r){var i=t[0],n=t[1],s=t[2],o=t[3];return e[0]=r[0]*i+r[4]*n+r[8]*s+r[12]*o,e[1]=r[1]*i+r[5]*n+r[9]*s+r[13]*o,e[2]=r[2]*i+r[6]*n+r[10]*s+r[14]*o,e[3]=r[3]*i+r[7]*n+r[11]*s+r[15]*o,e}(function(){var e=Le();return function(t,r,i,n,s,o){var a,c;for(r||(r=4),i||(i=0),n?c=Math.min(n*r+i,t.length):c=t.length,a=i;a<c;a+=r)e[0]=t[a],e[1]=t[a+1],e[2]=t[a+2],e[3]=t[a+3],s(e,e,o),t[a]=e[0],t[a+1]=e[1],t[a+2]=e[2],t[a+3]=e[3];return t}})();function X(){var e=new D(4);return D!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0),e[3]=1,e}function Oe(e){return e[0]=0,e[1]=0,e[2]=0,e[3]=1,e}function mt(e,t,r){r=r*.5;var i=Math.sin(r);return e[0]=i*t[0],e[1]=i*t[1],e[2]=i*t[2],e[3]=Math.cos(r),e}function Ht(e,t,r){var i=t[0],n=t[1],s=t[2],o=t[3],a=r[0],c=r[1],h=r[2],l=r[3];return e[0]=i*l+o*a+n*h-s*c,e[1]=n*l+o*c+s*a-i*h,e[2]=s*l+o*h+i*c-n*a,e[3]=o*l-i*a-n*c-s*h,e}function wt(e,t,r,i){var n=t[0],s=t[1],o=t[2],a=t[3],c=r[0],h=r[1],l=r[2],u=r[3],f,m,v,p,b;return m=n*c+s*h+o*l+a*u,m<0&&(m=-m,c=-c,h=-h,l=-l,u=-u),1-m>Te?(f=Math.acos(m),v=Math.sin(f),p=Math.sin((1-i)*f)/v,b=Math.sin(i*f)/v):(p=1-i,b=i),e[0]=p*n+b*c,e[1]=p*s+b*h,e[2]=p*o+b*l,e[3]=p*a+b*u,e}function Ie(e,t){var r=t[0]+t[4]+t[8],i;if(r>0)i=Math.sqrt(r+1),e[3]=.5*i,i=.5/i,e[0]=(t[5]-t[7])*i,e[1]=(t[6]-t[2])*i,e[2]=(t[1]-t[3])*i;else{var n=0;t[4]>t[0]&&(n=1),t[8]>t[n*3+n]&&(n=2);var s=(n+1)%3,o=(n+2)%3;i=Math.sqrt(t[n*3+n]-t[s*3+s]-t[o*3+o]+1),e[n]=.5*i,i=.5/i,e[3]=(t[s*3+o]-t[o*3+s])*i,e[s]=(t[s*3+n]+t[n*3+s])*i,e[o]=(t[o*3+n]+t[n*3+o])*i}return e}function Ge(e,t,r,i){var n=arguments.length>4&&arguments[4]!==void 0?arguments[4]:Fe,s=Math.PI/360;t*=s,i*=s,r*=s;var o=Math.sin(t),a=Math.cos(t),c=Math.sin(r),h=Math.cos(r),l=Math.sin(i),u=Math.cos(i);switch(n){case"xyz":e[0]=o*h*u+a*c*l,e[1]=a*c*u-o*h*l,e[2]=a*h*l+o*c*u,e[3]=a*h*u-o*c*l;break;case"xzy":e[0]=o*h*u-a*c*l,e[1]=a*c*u-o*h*l,e[2]=a*h*l+o*c*u,e[3]=a*h*u+o*c*l;break;case"yxz":e[0]=o*h*u+a*c*l,e[1]=a*c*u-o*h*l,e[2]=a*h*l-o*c*u,e[3]=a*h*u+o*c*l;break;case"yzx":e[0]=o*h*u+a*c*l,e[1]=a*c*u+o*h*l,e[2]=a*h*l-o*c*u,e[3]=a*h*u-o*c*l;break;case"zxy":e[0]=o*h*u-a*c*l,e[1]=a*c*u+o*h*l,e[2]=a*h*l+o*c*u,e[3]=a*h*u-o*c*l;break;case"zyx":e[0]=o*h*u-a*c*l,e[1]=a*c*u+o*h*l,e[2]=a*h*l-o*c*u,e[3]=a*h*u+o*c*l;break;default:throw new Error("Unknown angle order "+n)}return e}var Ne=Be,zt=Ht,qt=ze;(function(){var e=T(),t=A(1,0,0),r=A(0,1,0);return function(i,n,s){var o=Yt(n,s);return o<-.999999?(gt(e,t,n),Ve(e)<1e-6&&gt(e,r,n),O(e,e),mt(i,e,Math.PI),i):o>.999999?(i[0]=0,i[1]=0,i[2]=0,i[3]=1,i):(gt(e,n,s),i[0]=e[0],i[1]=e[1],i[2]=e[2],i[3]=1+o,qt(i,i))}})();(function(){var e=X(),t=X();return function(r,i,n,s,o,a){return wt(e,i,o,a),wt(t,n,s,a),wt(r,e,t,2*a*(1-a)),r}})();(function(){var e=Re();return function(t,r,i,n){return e[0]=i[0],e[3]=i[1],e[6]=i[2],e[1]=n[0],e[4]=n[1],e[7]=n[2],e[2]=-r[0],e[5]=-r[1],e[8]=-r[2],qt(t,Ie(t,e))}})();function $t(){var e=new D(2);return D!=Float32Array&&(e[0]=0,e[1]=0),e}function Ft(e,t){var r=new D(2);return r[0]=e,r[1]=t,r}function Ot(e,t){return e[0]=t[0],e[1]=t[1],e}function ke(e,t,r){return e[0]=t,e[1]=r,e}(function(){var e=$t();return function(t,r,i,n,s,o){var a,c;for(r||(r=2),i||(i=0),n?c=Math.min(n*r+i,t.length):c=t.length,a=i;a<c;a+=r)e[0]=t[a],e[1]=t[a+1],s(e,e,o),t[a]=e[0],t[a+1]=e[1];return t}})();class Xe{position;rotation;scale;localMatrix;worldMatrix;_dirty=!0;parent=null;children=[];constructor(){this.position=T(),this.rotation=X(),this.scale=A(1,1,1),this.localMatrix=$(),this.worldMatrix=$()}setParent(t){if(this.parent!==t){if(this.parent){const r=this.parent.children.indexOf(this);r>=0&&this.parent.children.splice(r,1)}this.parent=t,t&&t.children.push(this),this.markDirty()}}updateMatrix(){return this.parent&&this.parent.updateMatrix(),this._dirty&&(Ae(this.localMatrix,this.rotation,this.position,this.scale),this.parent?Tt(this.worldMatrix,this.parent.worldMatrix,this.localMatrix):Me(this.worldMatrix,this.localMatrix),this._dirty=!1),this.worldMatrix}updateHierarchy(){this.updateMatrix();for(const t of this.children)t.updateHierarchy()}getWorldPosition(t){this.updateMatrix();const r=this.worldMatrix,i=t??T();return G(i,r[12],r[13],r[14]),i}getForward(t){this.updateMatrix();const r=this.worldMatrix,i=t??T();return G(i,-r[8],-r[9],-r[10]),O(i,i)}getUp(t){this.updateMatrix();const r=this.worldMatrix,i=t??T();return G(i,r[4],r[5],r[6]),O(i,i)}getRight(t){this.updateMatrix();const r=this.worldMatrix,i=t??T();return G(i,r[0],r[1],r[2]),O(i,i)}translate(t){H(this.position,this.position,t),this.markDirty()}rotate(t,r){const i=X();mt(i,r,t),Ht(this.rotation,i,this.rotation),this.markDirty()}setScale(t){N(this.scale,t),this.markDirty()}setPosition(t){N(this.position,t),this.markDirty()}setRotation(t){Ne(this.rotation,t),this.markDirty()}setRotationEuler(t,r,i){const n=t*180/Math.PI,s=r*180/Math.PI,o=i*180/Math.PI;Ge(this.rotation,n,s,o),this.markDirty()}getWorldMatrix(){return this.updateMatrix()}getLocalMatrix(){return this._dirty&&this.updateMatrix(),this.localMatrix}markDirty(){if(!this._dirty){this._dirty=!0;for(const t of this.children)t.markDirty()}}getRoot(){let t=this;for(;t.parent;)t=t.parent;return t}*getParents(){let t=this.parent;for(;t;)yield t,t=t.parent}}let We=1;class B{active=!0;destroyed=!1;transform=new Xe;components=[];componentStarted=new WeakMap;id;name;layer=1;scene;constructor(t="GameObject"){this.id=We++,this.name=t}setActive(t){if(this.active!==t)if(this.active=t,t)for(const r of this.components)r.onEnable?.();else for(const r of this.components)r.onDisable?.()}addComponent(t){return this.components.push(t),t.owner=this,t.onAttach?.(),t}getComponent(t){for(const r of this.components)if(r instanceof t)return r;return null}getComponents(t){const r=[];for(const i of this.components)i instanceof t&&r.push(i);return r}removeComponent(t){const r=this.components.indexOf(t);r>=0&&(this.components.splice(r,1),t.onDetach?.())}update(t){if(!(!this.active||this.destroyed)){for(const r of this.components)this.componentStarted.get(r)||(r.start?.(),this.componentStarted.set(r,!0));this.components.forEach(r=>r.enabled&&r.update?.(t))}}destroy(){this.destroyed||(this.destroyed=!0,this.active=!1,this.scene?.markForDestroy(this))}forEachComponent(t){for(const r of this.components)t(r)}}class je{gl;uniforms;program;constructor(t,r,i){this.gl=t,this.uniforms=new Map,this.program=Ye(t,r,i),this.uniforms=He(t,this.program)}bind(){this.gl.useProgram(this.program)}}function Ye(e,t,r){let i=e.createProgram();if(!i)throw new Error("WebGLProgram を作成できませんでした");return e.attachShader(i,t),e.attachShader(i,r),e.linkProgram(i),e.getProgramParameter(i,e.LINK_STATUS)||console.trace(e.getProgramInfoLog(i)),i}function He(e,t){let r=new Map,i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let n=0;n<i;n++){let s=e.getActiveUniform(t,n);if(!s)continue;let o=s.name;r.set(o,e.getUniformLocation(t,o))}return r}function It(e,t,r,i){r=qe(r);const n=e.createShader(t);if(!n)throw new Error("shader が見つかりません");return e.shaderSource(n,r),e.compileShader(n),e.getShaderParameter(n,e.COMPILE_STATUS)||console.trace(e.getShaderInfoLog(n)),n}function qe(e,t){return e}function M(e,t){const r=e.uniforms.get(t);if(r==null)throw new Error(`Required uniform '${t}' is missing in program`);return r}function Y(e,t){return e.uniforms.get(t)??null}class $e{enabled=!0;cullingMask=-1;owner;gl;fov;aspect;near;far;yaw;pitch;viewMatrix;projectionMatrix;_vp;_invVP;_qYaw;_qPitch;_q;constructor(t,r){this.gl=t,this.fov=r?.fov??Math.PI/4,this.aspect=r?.aspect??1,this.near=r?.near??.1,this.far=r?.far??1e3,this.yaw=r?.yaw??-Math.PI/2,this.pitch=r?.pitch??0,this.viewMatrix=$(),this.projectionMatrix=$(),this._vp=$(),this._invVP=$(),this._qYaw=X(),this._qPitch=X(),this._q=X()}start(){}update(t){this.updateMatrices()}onAttach(){this.updateMatrices()}onDetach(){}rotate(t,r){this.yaw+=t,this.pitch+=r;const i=Math.PI/2-.01;this.pitch>i&&(this.pitch=i),this.pitch<-i&&(this.pitch=-i),this.updateMatrices()}setAspect(t){this.aspect=t,this.updateMatrices()}getFov(){return this.fov}getAspect(){return this.aspect}updateMatrices(){if(!this.owner)return;mt(this._qYaw,[0,1,0],this.yaw),mt(this._qPitch,[1,0,0],this.pitch),Oe(this._q),zt(this._q,this._qPitch,this._q),zt(this._q,this._qYaw,this._q),this.owner.transform.setRotation(this._q);const t=this.owner.transform.getWorldMatrix();Bt(this.viewMatrix,t),De(this.projectionMatrix,this.fov,this.aspect,this.near,this.far)}updateShaderUniforms(t){const r=M(t,"uViewMat"),i=M(t,"uProjectionMat");this.gl.uniformMatrix4fv(r,!1,this.viewMatrix),this.gl.uniformMatrix4fv(i,!1,this.projectionMatrix)}worldToScreenUV(t){const r=k(t[0],t[1],t[2],1);Tt(this._vp,this.projectionMatrix,this.viewMatrix),xt(r,r,this._vp);const i=r[0]/r[3],n=r[1]/r[3],s=i*.5+.5,o=n*.5+.5;return{u:s,v:o}}screenUVToWorldOnPlane(t,r,i){const n=t*2-1,s=r*2-1;if(Tt(this._vp,this.projectionMatrix,this.viewMatrix),!Bt(this._invVP,this._vp))return null;const o=k(n,s,-1,1),a=k(n,s,1,1);xt(o,o,this._invVP),xt(a,a,this._invVP);for(const p of[o,a])p[0]/=p[3],p[1]/=p[3],p[2]/=p[3],p[3]=1;const c=A(o[0],o[1],o[2]),h=A(a[0],a[1],a[2]),l=T();ct(l,h,c),O(l,l);const u=c,f=l[2];if(Math.abs(f)<1e-6)return null;const m=(i-u[2])/f;if(m<0)return null;const v=T();return jt(v,u,l,m),v}isInView(t,r=0){const i=this.worldToScreenUV(t),n=i.u,s=i.v;return n>=-r&&n<=1+r&&s>=-r&&s<=1+r}getViewInfo(t,r=0){const i=this.worldToScreenUV(t);return{visible:i.u>=-r&&i.u<=1+r&&i.v>=-r&&i.v<=1+r,uv:i}}}const vt=`precision highp float;\r
\r
...
}`,Ze=`// shaders/streamBulletField.frag\r
